...
Note: you can even have line breaks in a paragraph, and markdown will just ignore them (or, rather, replace them with spaces). Markdown's looking for an empty line before it ends a paragraph.
{:.box}

...
[Read the guide](http://electricbookworks.github.io/electric-book-workflow/). As a little book, the guide is also an example of the workflow (version {{ site.version }}) in action.
